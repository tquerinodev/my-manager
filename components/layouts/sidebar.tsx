...
const Sidebar = () => {
    ...
    return (
        <div className={semidark ? 'dark' : ''}>
            ...
            >
                <div className="h-full bg-menuColor rounded-tr-2xl dark:bg-black ">
                    <div className="flex items-center justify-between px-4 py-3">
                        <Link href="/" className="main-logo flex shrink-0 items-center">
                            <img className="ml-[5px] w-8 flex-none" src="/assets/images/logo.svg" alt="logo" />
                            <span className="align-middle text-2xl font-semibold ltr:ml-1.5 rtl:mr-1.5 dark:text-white-light lg:inline">Deck Jurídico</span>
                        </Link>
                    ...
                    <ul className="relative space-y-0.5 p-4 py-0 font-semibold">
                            ...
                            <li className="menu nav-item">
                                <button type="button" className={`${currentMenu === 'painel' ? 'active' : ''} nav-link group w-full`} onClick={() => toggleMenu('painel')}>
                                    <div className="flex items-center">
                                        <IconMenuDashboard className="shrink-0 group-hover:!text-primary" />
                                        <span className="text-black ltr:pl-3 rtl:pr-3 dark:text-[#506690] dark:group-hover:text-white-dark">{t('painel')}</span>
                                    </div>

                                    <div className={currentMenu !== 'painel' ? '-rotate-90 rtl:rotate-90' : ''}>
                                        <IconCaretDown />
                                    </div>
                                </button>

                                <AnimateHeight duration={300} height={currentMenu === 'painel' ? 'auto' : 0}>
                                    <ul className="sub-menu text-gray-500">
                                        <li>
                                            <Link href="/">{t('Estatísticas')}</Link>
                                        </li>
                                ...
                                <ul>
                                    ...
                                    <li className="menu nav-item">
                                        ...
                                        <AnimateHeight duration={300} height={currentMenu === 'invoice' ? 'auto' : 0}>
                                            <ul className="sub-menu text-gray-500">
                                                <li>
                                                    <Link href="/revisoes/">{t('list')}</Link>
                                                </li>
                                                <li>
